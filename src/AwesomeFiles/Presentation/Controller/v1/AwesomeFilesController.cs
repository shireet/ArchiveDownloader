...
public class AwesomeFilesController(IMediator mediator) : ControllerBase
{
    ...
    {
        var getAllFilesRequest = new GetAllFilesRequest();
    ...
    {
        var startArchiveRequest = new BLL.Services.StartArchive.StartArchiveRequest(request.FileNames.Select(x => x).ToList());
    ...
    {
        var getArchiveTaskStatusRequest = new BLL.Services.GetArchiveTaskStatus.GetArchiveTaskStatusRequest(id);
    ...
    {
        var getArchiveRequest = new BLL.Services.GetArchive.GetArchiveRequest(id);
